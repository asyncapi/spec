...
<a name="parameterObjectMultiLevel"></a>multiLevel | `boolean` | Whether a parameter spans across multiple levels or not. Levels are the pieces of text delimited by slashes (`/`). Defaults to `false`.
