...
<a name="channelItemObjectServers"></a>servers | [[Reference Object](#referenceObject)] | An optional unordered list of [Reference Objects](#referenceObject) pointing to [Server Objects](#serverObject), such as those declared in [Servers](#componentsServers) under the [Components Object](#componentsObject). If `servers` is absent or empty then the channel must be applicable to all servers defined in the top-level [Servers Object](#serversObject).
